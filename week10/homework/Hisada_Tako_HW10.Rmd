...
```{r q2_2}
plot(data$cigs, data$bwght, xlab="number of cigarettes smoked by the mother each day during pregnacy",
...
The slope coefficient indicates that for each incremental cigarette that the mother smokes, the infant birth weight decreases by `r model_smoking$coef[2]` ounces.
...
The mother would have to be smoking 38.5 cigarrets each day for the predicted birth hweight to be 100 ounces.