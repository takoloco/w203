...
Our n for Republicans is `r rep_ages_n` and for Democrats is `r dem_ages_n`. The distributions are fairly normal as seen above and our ns is sufficiently large. We can conduct a t-test in determining if $\mu_1$ is in fact greater than $\mu_2$.
