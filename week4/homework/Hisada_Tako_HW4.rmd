...
\[ = -100 * \frac{2}{3}(1-x)^\frac{3}{2} = -\frac{200}{3}(1-x)^\frac{3}{2}|_{0}^{1} = \frac{200}{3} \]
...
\[ F(X) = P(X <= x) = \int_0^{x} f(y)dy = \int_0^{x} 1-\frac{x^2}{10000}dy = x - \frac{x^3}{30000} \]


#### iv.

\[ F'(X) = 1 - \frac{x^2}{10000} \]

#### v.

\[ E(X) = \int_{-\infty}^{\infty} x*f(x)dx = \int_{0}^{100} x*(1-\frac{x^2}{10000}) dx \]
\[ = 2x^2-\frac{x^4}{40000} |_{0}^{100} = 100 - \frac{1000000}{10000} \]
